...
import { useTypedDispatch, useTypedSelector } from "@/lib/hooks/typed-redux-hooks";
...
const NavLinks = () => {
  ...
  const freeExplorationHandler = () => {
    ...
    dispatch(
      setTimeSeriesData({
        on: false,
        chinaEmissions: false,
        usEmissions: false,
        indiaEmissions: false,
        russiaEmissions: false,
      }),
    );
  };
  ...
  const landingPageLinks: LinkItem[] = [
    { text: "Explore Your Impact", onClick: scrollToExploreHandler },
    { text: "About Carbon Zero", onClick: scrollToAboutHandler },
    { text: "Contact Us", onClick: scrollToContactHandler },
  ];
